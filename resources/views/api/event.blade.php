...
<form method="post" action="/api/update-event">
  @csrf
  <input type="text" id="event-id" name="event-id" class="input-field" placeholder="Enter event ID">
  ...
  <input type="text" id="description" name="description" class="input-field" placeholder="Enter event name">
  <br>
